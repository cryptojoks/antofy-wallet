      ...
      <Container>
        <div className="Section-head">
          ...
          <div className="Section-info Section-70">
            One of the key ideas driving the engineering and creative process for Antofy is to make decentralized financial layer accessible,
            easy and enjoyable. <br /><br />
            To deliver unmatched performance and wider selection of features Antofy is being built using native iOS and Android technologies.
