...
Antofy is one of the few mobile-based cryptocurrency wallets that provides an ability to connect to any DeFi service built on top of Ethereum or Binance Smart Chain blockchains using an open WalletConnect protocol.

Take the following steps to use Antofy wallet with a DeFi service:
...
3. Open the Antofy wallet app and navigate to the Settings tab.
