...
Antofy enables easy management for an unlimited number of multi-coin crypto wallets.
...
The Balance tab on Antofy always shows the currently active wallet. To switch between activated wallets users may:
