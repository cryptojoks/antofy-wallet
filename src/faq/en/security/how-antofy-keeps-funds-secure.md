# How does Antofy keep funds secure?

Every non-custodial wallet incl. Antofy at its core is an instrument meant to securely store a wallet owner's private key(s).
...
Antofy wallet stores private keys using secure storage mechanisms provided by iOS and Android operating systems.
